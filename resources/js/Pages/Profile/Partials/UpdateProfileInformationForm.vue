    ...
    <template #form>
      ...
      <div class="form-group" v-if="$page.props.jetstream.managesProfilePhotos">
        ...
        <div class="mt-2" v-show="! photoPreview" >
          <img :src="user.profile_photo_url" alt="Current Profile Photo" class="rounded-circle" width="80px" height="80px">
        </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    sizingPhoto(){
      this.imagem = document.querySelectorAll("img[class=rounded-circle]");

      this.imagem.forEach((img) => {
